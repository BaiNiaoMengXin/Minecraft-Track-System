...
export class ShardDataBase<V = any> {

    static readonly databases = new Array<ShardDataBase<any>>()
    private cache: Record<string, any>

    public constructor(readonly name: string, private readonly defaultValue: string = "{}") {
        ShardDataBase.databases.push(this)
        this.cache = ShardDataBase.getAll(this.name, this.defaultValue)
    }
    ...
    public getAll(): Record<string, V> {
        return this.cache ??= ShardDataBase.getAll(this.name, this.defaultValue)
    }
